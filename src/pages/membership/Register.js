        ...
        <div initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }} id='register-page-container'>
            <form onSubmit={handleSubmit} id="register-form" className="rounded-3" >
                ...
                <div style={{ textStroke: "1px" }} className="d-flex align-items-center mb-3">
                    ...
                    <h3 className="w-50 h-100 m-0 p-3 text-center border-start border-dark" ref={locationStateRef}><NavLink to="/login" className="text-uppercase text-white fw-bold fs-5 h-100">login</NavLink></h3>
                </div>
                ...
                <div className="w-100 d-flex align-items-start justify-content-center my-3">
                    ...
                    <input onChange={handleChange} name="email" value={register.email} className="border-0 flex-fill me-2 align-self-stretch bg-transparent text-white border-bottom" type="text" placeholder='Your Email' />
                </div>

                <div className="w-100 d-flex align-items-start justify-content-center my-3">
                    <RiLockPasswordLine color="white" size={20} className="mx-3 my-auto" />
                    <input onChange={handleChange} name="password" value={register.password} className="border-0 flex-fill me-2 align-self-stretch bg-transparent text-white border-bottom" type={showPassword ? "text" : "password"} placeholder='Your Password' />
                    {
                        showPassword ?
                ...
                <div className="w-100 d-flex align-items-start justify-content-center my-3">
                    ...
                    <input onChange={handleChange} name="rePassword" value={register.rePassword} className="border-0 flex-fill me-2 align-self-stretch bg-transparent text-white border-bottom" type={showPassword ? "text" : "password"} placeholder='Re-enter Password' />
                    {
                        showPassword ?
                            <BsEye onClick={() => setShowPassword(!showPassword)} color='white' className='my-auto me-3' size={20} /> :
                            <BsEyeSlash onClick={() => setShowPassword(!showPassword)} color='white' className='my-auto me-3' size={20} />
                ...
                <div className="mx-3 mt-4 mb-3 d-flex align-items-center justify-content-center flex-column">
                    <button style={{ background: "linear-gradient(to right,rgba(0,0,0,.7),rgba(0,0,0,.7))" }} className="text-uppercase w-100 border-0 fw-bold py-2 text-white" type="submit">register</button>
                </div>
