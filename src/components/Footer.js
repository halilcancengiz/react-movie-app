...
export default function Footer() {
    ...
    return (
        <footer className='bg-dark container-fluid d-flex align-items-center justify-content-center p-5'>
                ...
                <div className="row m-0 p-0 g-0">
                    <div className="col-12">
                        ...
                        <div className='text-center d-flex align-items-center justify-content-center'>
                            ...
                            <NavLink style={{ width: "50px", height: "50px" }} className="tmdb-footer-logo p-2" rel='noreferrer' target="_blank" href="https://www.themoviedb.org/">
